...
$opt['locale']['EN']['format']['datelong'] = 'd F Y';
...
$opt['locale']['SV']['format']['datetime'] = 'x H:i';
$opt['locale']['SV']['format']['datetimesec'] = 'x X';
$opt['locale']['SV']['format']['time'] = 'H:i';
...
$opt['locale']['DA']['format']['datetime'] = 'x H:i';
$opt['locale']['DA']['format']['datetimesec'] = 'x X';
$opt['locale']['DA']['format']['time'] = 'H:i';
...
$opt['locale']['PT']['format']['datetime'] = 'x H:i';
$opt['locale']['PT']['format']['datetimesec'] = 'x X';
$opt['locale']['PT']['format']['time'] = 'H:i';
...
$opt['locale']['JA']['format']['datetime'] = 'x H:i';
$opt['locale']['JA']['format']['datetimesec'] = 'x X';
$opt['locale']['JA']['format']['time'] = 'H:i';
