...
***************************************************************************}
    ...
    <div class="content-txtbox-noshade" style="padding-right: 25px;">
        ...
        <p>Vielen Dank, dass du die Spenden-Seite von OpenCaching.de aufrufst. Unser Verein betreibt diese Plattform rein ehrenamtlich. Unser Ziel ist es, ein werbefreies, kostenloses und unabhängiges Angebot für die Caching-Community zu erhalten.</p>
        ...
        <div style="display: inline-block; text-align: center;">
            <img src="resource2/misc/donation/oc-epc-qr-code.png" alt="EPC-QR-Code für Überweisung" style="width: 180px; height: 180px;" />
